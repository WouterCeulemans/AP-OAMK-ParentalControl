...
?>
        ...
        <div class="divContent">
            <form method="post" action="register.php" name="Register">
                <table>
                    <tr><td>Username:		 </td><td><input type="text"     name="UserName" value="<?php echo $_POST["UserName"]; ?>" /> <br /></td></tr>
                    <tr><td>Name:            </td><td><input type="text"     name="Name"     value="<?php echo $_POST["Name"];     ?>" /> <br /></td></tr>
                    <tr><td>Last Name:       </td><td><input type="text"     name="LastName" value="<?php echo $_POST["LastName"]; ?>" /> <br /></td></tr>
                    ...
                    <tr><td>E-Mail:          </td><td><input type="email"    name="Email"    value="<?php echo $_POST["Email"];    ?>" /> <br /></td></tr>
                </table>
